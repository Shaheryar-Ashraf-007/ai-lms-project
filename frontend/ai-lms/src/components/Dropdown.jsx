  ...
  return (
    <>
      ...
      <div className='w-52 rounded-xl bg-white shadow-2xl border border-gray-100 absolute right-4 top-16 overflow-hidden z-50'>
        {/* Menu Items */}
        <div className='p-2'>
          <div className='flex items-center gap-3 hover:bg-gradient-to-r hover:from-[#FBB03B] hover:to-[#f5a732] p-3 rounded-lg cursor-pointer transition-all duration-200 group text-gray-700 hover:text-white' onClick={()=>navigate("/profile")}>
